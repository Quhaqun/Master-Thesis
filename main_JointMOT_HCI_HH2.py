...
def Main():
    ...
    displayTextcenter(Introduction, shiftup=HEIGHT/4, fontcolor = BLACK)
    displayTextcenter(Rights_Participant, shiftup=HEIGHT/3, fontcolor = BLACK)
    ...
    for trial in range(0,TRIALS):
        ...
        if (CURTRIALTYPE == "SoloTrainingStart"):
            displayTextcenter(Instruction_Text_Solo, shiftup=HEIGHT/8, fontcolor = BLACK)
            displayTextcenter(Announce_Solo_Training, shiftup=0, fontcolor = BLACK)
            CONDITION = "SoloTraining"

        if (CURTRIALTYPE == "SoloStart"):
            displayTextcenter(Announce_Solo_experiment, shiftup=HEIGHT/8, fontcolor = BLACK)
            CONDITION = "Solo"

        if (CURTRIALTYPE == "JointTrainingStart"):
            displayTextcenter(Instruction_Text_Joint, shiftup=HEIGHT/4, fontcolor = BLACK)

            if PARTNER == "Confederate":
                displayTextcenterWait(Connectingpartner,waitforconnect, shiftup=HEIGHT/4, fontcolor = BLACK)
                displayTextcenter(Connectingpartner_success, shiftup=HEIGHT/4, fontcolor = BLACK)

            displayTextcenter(Announce_Joint_training, shiftup=0, fontcolor = BLACK)

            CONDITION = "JointTraining"

        if (CURTRIALTYPE == "Jointstart"):
            displayTextcenter(Announce_Joint_experiment, shiftup=HEIGHT/8, fontcolor = BLACK)
            CONDITION = "Joint"
        ...
        assign_corrident, assign_rt, assignperf, assignorder, assignobjidx, assigncor_objidx, assignwrong_objidx, objects, ReactiontimeSelection = markall(objects,"selection",Subnum, trial, SUBDIR)
        ...
        corrident, mark_rt, totalperf, selectorder, selobjidx, selcor_objidx, selwrong_objidx, objects, ReactiontimeMarkall = markall(objects,"markall",Subnum, trial, SUBDIR)
    ...
    displayTextcenter(EndExperiment, shiftup=0, fontcolor = BLACK)
